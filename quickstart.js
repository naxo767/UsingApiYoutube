...
//Esta parte del código lee las credenciales para poder usar los scopes autorizados en el array de arriba
fs.readFile('credentials.json', function processClientSecrets(err, content) {
 ...
 //En ese caso llamamos a la función getChannel en la que recogeremos las urls de los videos
...
//Estas llamadas crean una lista con los videos y la introducen en response, response1, response2 etc... Cada llamada recoge 50 videos por eso deer hacerse varias veces
  service.activities.list({
    auth: auth,
    part: 'snippet,contentDetails,id',
    channelId: 'UCTvV-CVfqxh6UTj-2nvTa6A',
    maxResults: 100
                            ...
                            if (err) {
                                ...
                                service.activities.list({
                                    ...
                                    if (err) {
                                      ...
                                      //Si desbloqueamos esta parte podriamos llegar a recoger unos 300 videos de un canal especifico
                                       ...
                                       //Introducimos en el array activities las respuestas con los vídeos
                                       var activities2=response1.data.items;
                                       var activities1=response.data.items;
                                       var activities = activities1.concat(activities2);
...
//Cambia las celdas de las urls de los videos
...
//cambia las celdas con los nombres de los videos
...
function RellenarCuestionarios(auth, activities,spreadsheetId) {
  if (activities.length == 0) {
    ...
    for (i = 0; i < activities.length; i++) {
      //Recogemos las urls de los videos y sus nombres y los introducimos en request y request1 que son las peticiones que harán luego a la hoja de excel para cambiar las celdas
